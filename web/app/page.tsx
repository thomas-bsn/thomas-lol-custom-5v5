...
function VisualResult() {
  return (
    <svg viewBox="0 0 300 155" xmlns="http://www.w3.org/2000/svg" style={{ display: "block", width: "100%" }}>
      ...
      {/* sidebar */}
      <rect width="72" height="155" fill="#111" />
      <text x="10" y="20" fill="white" fontSize="8" fontWeight="800">THOMA$</text>
      <text x="10" y="29" fill="rgba(255,255,255,0.3)" fontSize="6">LoL Tournament</text>
      {[
        { y: 44, label: "🏠 Accueil" },
        { y: 57, label: "⚔️ Picker" },
      ...
      {/* badge pending */}
      <rect x="6" y="100" width="60" height="18" rx="5" fill="rgba(255,185,50,0.12)" stroke="rgba(255,185,50,0.4)" strokeWidth="0.8" />
      <text x="12" y="112" fill="#FFB932" fontSize="6.5" fontWeight="700">⏳ 1 en attente</text>
      <text x="56" y="112" fill="rgba(255,185,50,0.5)" fontSize="5">▼</text>

      {/* flèche */}
      <path d="M 69 109 Q 88 109 88 65" stroke="rgba(255,185,50,0.35)" strokeWidth="1" fill="none" strokeDasharray="3 2" />
      <polygon points="86,61 88,65 90,61" fill="rgba(255,185,50,0.35)" />

      {/* modal */}
      <rect x="92" y="14" width="142" height="128" rx="10" fill="#141414" stroke="rgba(255,255,255,0.1)" strokeWidth="0.8" />
      <text x="104" y="30" fill="white" fontSize="7.5" fontWeight="700">Game #3</text>
      <text x="104" y="39" fill="rgba(255,255,255,0.3)" fontSize="5.5">12/04 · 21h30</text>

      {/* Blue team */}
      <rect x="104" y="46" width="54" height="54" rx="5" fill="rgba(80,180,255,0.06)" stroke="rgba(80,180,255,0.25)" strokeWidth="0.7" />
      <rect x="104" y="46" width="54" height="13" rx="5" fill="rgba(80,180,255,0.12)" />
      <text x="110" y="55.5" fill="#50B4FF" fontSize="6" fontWeight="700">Blue</text>
      {["Aymen", "Mehdi", "Fares", "Xavier", "Sam"].map((n, i) => (
        <text key={n} x="110" y={67 + i * 8} fill="rgba(255,255,255,0.55)" fontSize="5.5">{n}</text>
      ))}

      {/* Red team */}
      <rect x="164" y="46" width="54" height="54" rx="5" fill="rgba(255,80,80,0.06)" stroke="rgba(255,80,80,0.25)" strokeWidth="0.7" />
      <rect x="164" y="46" width="54" height="13" rx="5" fill="rgba(255,80,80,0.1)" />
      <text x="170" y="55.5" fill="#FF5050" fontSize="6" fontWeight="700">Red</text>
      {["Pehdi", "Samy", "Qao", "Thomas", "Kylian"].map((n, i) => (
        <text key={n} x="170" y={67 + i * 8} fill="rgba(255,255,255,0.55)" fontSize="5.5">{n}</text>
      ))}

      {/* Boutons */}
      <rect x="104" y="108" width="54" height="14" rx="4" fill="rgba(80,180,255,0.15)" stroke="rgba(80,180,255,0.4)" strokeWidth="0.7" />
      <text x="131" y="117" fill="#50B4FF" fontSize="6" fontWeight="700" textAnchor="middle">Blue a gagné</text>
      <rect x="164" y="108" width="54" height="14" rx="4" fill="rgba(255,80,80,0.12)" stroke="rgba(255,80,80,0.4)" strokeWidth="0.7" />
      <text x="191" y="117" fill="#FF5050" fontSize="6" fontWeight="700" textAnchor="middle">Red a gagné</text>
    </svg>
  );
}
